...
const faqList: Faq[] = [
  {
    ...
    answer:
      "可以。DLAB水質檢測儀提供多參數組合探頭設計，讓您不必攜帶多台儀器。例如，筆型DPC1/DPC1+ 型號結合了 pH、電導度（Cond）、TDS、電阻率（RES）和鹽度（Sal.），並可額外購買ORP探頭，實現一機多用。此外，掌上型與桌上型多參數檢測設備能同時顯示 pH、電導度、溶解氧（DO）等多項數據。",
  },
  {
    isActive: false,
  ...
  {
    isActive: false,
    question: "06、DLAB水質檢測儀有提供標準的校準溶液嗎？",
    answer:
      "是的，DLAB水質檢測儀通常隨附標準解決方案和所需配件。 不同的檢測設備套件會包含對應的校準緩衝液、標準液、樣品瓶和浸泡溶液等。例如，pH 檢測設備套件會包含 pH 4.00/7.00/10.01 緩衝溶液。",
  },
  {
    isActive: false,
    question: "07、如果我需要更換探頭，DLAB是否提供容易替換的設計？更換探頭的費用高嗎？",
    answer:
      "DLAB水質檢測儀採用了可替換探頭設計，這簡化了維護過程並降低了長期成本。 無論是筆型（如 DPC1/DPC1+）還是掌上型，都強調了可更換的組合探頭設計，以滿足不同的應用需求。您可以根據測量參數選擇對應的替換探頭，如 DPH1-S、DORP1-S、DEC1-S 或 DPC1-S 等。",
  },

...
const faqList: Faq[] = [
  {
    isActive: true,
    question: "01、我需要檢測多種水質參數，DLAB水質檢測設備可以一次滿足我的需求嗎？",
    answer:
      "可以。DLAB水質檢測設備提供多參數組合探頭設計，讓您不必攜帶多台儀器。例如，筆型DPC1/DPC1+ 型號結合了 pH、電導度（Cond）、TDS、電阻率（RES）和鹽度（Sal.），並可額外購買ORP探頭，實現一機多用。此外，掌上型與桌上型多參數檢測設備能同時顯示 pH、電導度、溶解氧（DO）等多項數據。",
  },
  {
    isActive: false,
    question: "02、DLAB水質檢測設備是否支援數據記錄和導出功能，方便我進行報告分析？",
    answer:
      "是的，支援數據管理是 DLAB水質檢測設備的特點之一。</br>儲存容量：掌上型檢測設備數據儲存量高達3000 組, 桌上型檢測設備500 組（如 Benchtop 觸控螢幕系列）。</br>導出方式： 您可以透過多種方式導出數據，包括 Flash disk（隨身碟）、PC、無線印表機（選配），或透過行動 APP 實現數據儲存和分享。",
  },
  {
    isActive: false,
    question: "03、如何啟動或關閉DLAB水質檢測設備，以及快速切換背光模式？",
  ...
  {
    isActive: false,
    question: "05、DLAB水質檢測設備是否有低電壓提示，確保我不會在關鍵時刻因沒電而中斷測量？",
    answer:
      "有的，DLAB水質檢測設備設計有低電壓指示功能，確保您可以及時更換電池或充電。筆型水質檢測設備使用 4 顆 1.5V AAA 鹼性電池，而掌上型使用可充電鋰電池，並配備 Type-C 或 USB 充電插槽，符合歐洲新規範要求，桌上型則使用變壓器供給電源。",
  },
  {
    isActive: false,
    question: "06、DLAB水質檢測設備有提供標準的校準溶液嗎？",
    answer:
      "是的，DLAB水質檢測設備通常隨附標準解決方案和所需配件。 不同的檢測設備套件會包含對應的校準緩衝液、標準液、樣品瓶和浸泡溶液等。例如，pH 檢測設備套件會包含 pH 4.00/7.00/10.01 緩衝溶液。",
  },
  {
    isActive: false,
    question: "07、如果我需要更換探頭，DLAB是否提供容易替換的設計？更換探頭的費用高嗎？",
    answer:
      "DLAB水質檢測設備採用了可替換探頭設計，這簡化了維護過程並降低了長期成本。 無論是筆型（如 DPC1/DPC1+）還是掌上型，都強調了可更換的組合探頭設計，以滿足不同的應用需求。您可以根據測量參數選擇對應的替換探頭，如 DPH1-S、DORP1-S、DEC1-S 或 DPC1-S 等。",
  },

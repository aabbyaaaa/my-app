  ...
  return (
    <div className={styles.root}>
      ...
      <p className={styles.note}>
        本篇適用於實驗室日常水質測量，內容涵蓋儀器安裝、pH 標準液校正、<strong>自動穩定功能</strong>、<strong>Auto timing</strong> 記錄器的間隔設定，以及隨身碟/PC 的資料導出。
      </p>
      <ul className={styles.timeline}>
        <li className="work">
          ...
          <div className={styles.content}>
            <p>
              ...
              2、連接電極： 將玻璃複合 pH 電極（如 DPH-G）和不鏽鋼溫度電極（DTEMP）連接到水質檢測儀後方。<br />
        ...
        <li className="work">
          ...
          <div className={styles.content}>
            <p>
              1、進入校正模式： 透過水質檢測儀的使用者介面或按鍵進入校正（CAL）功能。<br />
              2、多點校正： DLAB 水質檢測儀支援 1~5點的 pH 自動校正(觸控型), 或1~3點(標準型)。選擇您所需的校正點數。<br />
              3、依序校正： 將 pH 電極依序浸入標準緩衝溶液中（例如 pH 4.00/7.00/10.01）。<br />
              4、確認儲存： 水質檢測儀會自動等待讀數穩定；一旦穩定，按下確認鍵或螢幕按鈕，儲存該校正點。<br />
        ...
        <li className="work">
          ...
          <div className={styles.content}>
            <p>
              1、開始測量： 將電極浸入待測水樣中，若使用觸控螢幕機型，可實現 pH/Cond/DO 同時顯示。<br />
        ...
        <li className="work">
          ...
          <div className={styles.content}>
            <p>
              1、進入設定： 透過圖形和文字的使用者介面，進入智慧功能選單或參數設定。<br />

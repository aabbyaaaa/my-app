...
export function Header() {
	...
	const links = [
		{
			label: '首頁',
			href: 'https://dgs.com.tw/',
		},
		{
			label: '品牌中心',
			href: 'https://dgs.com.tw/brands',
		},
		{
			label: '關於德記',
		...
		>
			...
			>
				...
				<div className="hidden items-center gap-2 md:flex">
					{links.map((link, i) => (
						<a key={i} className={buttonVariants({ variant: 'ghost' })} href={link.href} target="_blank" rel="noopener noreferrer">
							{link.label}
						</a>
					))}
					<Button variant="outline" asChild>
						<a href="https://lin.ee/VvNtwft" target="_blank" rel="noopener noreferrer">聯絡德記</a>
					</Button>
					<Button asChild>
						<a href="https://dgs.com.tw/product/collections/131" target="_blank" rel="noopener noreferrer">限時優惠</a>
					</Button>
				</div>
